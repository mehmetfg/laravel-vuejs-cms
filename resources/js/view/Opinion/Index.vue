<template>
    <div class="tab-pane" :class="{'active': opTab}" id="gorusler" role="tabpanel">
    <div class="m-portlet m-portlet--tab">
        ...
        <div class="m-portlet__head " :class="">
            ...
            <div class="m-portlet__head-tools">
                <router-link :to="{name:'add-opinion', params:{clientId:$route.params.clientId}}">
                    <a class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill text-white">
												<span>
																<i class="fa fa-plus "></i>
													<span>
														Yeni  Psikolog Görüş Ekle
													</span>
												</span>
                    </a></router-link>
            </div>
                ...
                <div class="m-section">
                    ...
                    <div class="m-section__content">
                        <table class="table">
                            ...
                            <tr v-for="item in opinions" :class="" :key="item.id">
                                <td>
                                ...
                                <td data-field="Actions"
                                    ...
                                    <router-link
                                            :to="{ name:'edit-opinion', params : {clientId:$route.params.clientId,  opinion : item}}">
...
<script>
    ...
    export default {
        ...
        created() {
                ...
                this.$store.dispatch("initClientOpinions", this.$route.params.clientId);
